...
export function SortableMovieList({
  ...
  >
    <div className={`p-3 flex flex-col relative min-h-[224px] ${listBoxClass} ${listIsOverflowing ? 'bg-red-100 dark:bg-red-800' : isActiveDropzone ? 'bg-indigo-50 dark:bg-blue-950' : ''} `}>
      ...
      <div className={'flex flex-row absolute right-3 justify-items-end gap-2'}>
        {!!movies.length && <div
      ...
      {showConfirmClearList && <div className="bg-red-100 dark:bg-red-900 left-0 top-0 absolute w-full h-full p-3">
